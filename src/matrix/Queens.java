...
public class Queens {
	...
	/*
	 * pre: There are queens in columns 0 to (column - 1). post: Queens have
	 * been placed in all the columns of board and PlaceQueens will return true,
	 * or PlaceQueens will return false.
	 */
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter the board Size: "); // Gain Size of board from
													// user
